...
const locations = [
  {
    ...
    position: [28.6139, 77.209] as [number, number], // New Delhi example
    emoji: "💫",
  },
  {
    id: 2,
      ...
      <>
        ...
        <div className="cm-container cm-map-container">
          <div className="cm-map-header">
            ...
            <p className="cm-map-subtitle">
              Real places where we created memories 🗺️
            </p>
          </div>
  ...
  return (
    <>
      ...
      <div className="cm-container cm-map-container">
        ...
        <div className="cm-map-display" key={mapKey}>
          <MapContainer
          ...
          {selectedLocation && (
            <div className="cm-location-info-card">
              <div className="cm-location-header">
                <span className="cm-location-emoji">
        ...
        <div className="cm-map-note">
          <p>
            💡 You can zoom and drag the map! Click on markers to see the
            special memories at each spot.
          </p>
        </div>
      </div>
    </>
