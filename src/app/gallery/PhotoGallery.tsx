...
const initialPhotos: Photo[] = [
  {
    ...
    date: "April 2024",
    src: "/photos/cherry_blossom_walk.png",
  },
  {
    id: 2,
    title: "Cozy Cafe Morning",
    date: "May 2024",
    src: "/photos/cafe_morning.png",
  },
  {
    id: 3,
    title: "Golden Hour Beach",
    date: "June 2024",
    src: "/photos/beach_sunset.png",
  },
  {
    id: 4,
    title: "Under the Stars",
    date: "July 2024",
    src: "/photos/stargazing_hill.png",
  },
  {
    id: 5,
    title: "Kitchen Chaos",
    date: "August 2024",
    src: "/photos/kitchen_chaos.png",
  },
  {
    id: 6,
    title: "Baking Together",
    date: "September 2024",
    src: "/photos/baking_together.png",
  },
  {
    id: 7,
    title: "Midnight Stroll",
    date: "October 2024",
    src: "/photos/midnight_stroll.png",
  },
  {
    id: 8,
    title: "Movie Marathon",
    date: "November 2024",
    src: "/photos/movie_marathon.png",
  },
  {
    id: 9,
    title: "Dancing in Rain",
    date: "December 2024",
    src: "/photos/dancing_in_rain.png",
  },
  {
    id: 10,
    title: "Picnic Day",
    date: "January 2025",
    src: "/photos/picnic_meadow.png",
  },
  {
    id: 11,
    title: "Winter Magic",
    date: "February 2025",
    src: "/photos/winter_skating.png",
  },
  {
    id: 12,
    title: "Travel Memories",
    date: "March 2025",
    src: "/photos/train_travel.png",
  },
];
      ...
      <div className="cm-container cm-gallery-container">
        <div className="cm-gallery-header">
          ...
          <p className="cm-gallery-subtitle">
            A collection of our most realistic and precious memories 💖
          </p>
        </div>
        ...
        <div
          className="cm-gallery-grid cm-gallery-grid-custom"
          ref={galleryRef}
        >
          {photos.map((photo, index) => (
            <div
              key={photo.id}
              className={`cm-gallery-item ${index % 5 === 0 ? "cm-large" : ""}`}
            >
