  ...
  return (
    <>
      ...
      <div className="cm-container cm-landing-container">
        <Image
          src="/logo.png"
          alt="Cute Moments Logo"
          width={96}
          height={96}
          className="mx-auto mb-6 rounded-full shadow-lg animate-bounce"
        />
        <h1 className="cm-landing-title">Celebrate Your Romantic Journey 💕</h1>
        <p className="cm-landing-subtitle">
          The ultimate digital space to cherish your relationship memories, send
          virtual hugs, and build your love story together. ✨
        </p>
