...
const cmSpecialDate = new Date("2024-02-14T00:00:00");
const cmNextAnniversary = new Date("2025-02-14T00:00:00");
    ...
    <>
      ...
      <div className="cm-container cm-countdown-container">
        ...
        <div className="cm-countdown-message">
          <p>
            &quot;In all the time we&apos;ve shared, my love for you has only
            grown stronger.&quot;
          </p>
        </div>
      </div>
